...
- In manage_cart, ALWAYS pass the product's name in product_name. Only pass product_id if you have the exact id from search_products results. price_eur must be a plain number like 4.99 — no currency symbol
